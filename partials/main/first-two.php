    ...
    <div class="col mb-4">
        <div class="card">
            <div class="ratio ratio-16x9">
                <img src="<?= get_the_post_thumbnail_url($post_id, '2048px') ?>" alt="<?= $alt_text ?>">
            </div>
            ...
            <div class="card-body shadow-sm"><a class="card-link text-decoration-none" href="<?= get_the_permalink() ?>" style="color: rgb(46,47,50);">
                ...
                <p class="card-text mt-3" style="font-size: 14px;font-family: Poppins, sans-serif;color: rgb(71,73,77);"><?= mb_strimwidth(get_the_excerpt(), 0, 185, '…'); ?></p>
