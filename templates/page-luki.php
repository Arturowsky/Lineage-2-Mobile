...
?>
    <main>
        <div class="text-white place-center" style="background: url('<?= get_template_directory_uri() ?>/assets/img/luki2.jpg') center / cover no-repeat;height: 600px; background-blend-mode: overlay;">
            <div>
                <h1 class="display-1 text-center mx-2" style="font-family: Poppins, sans-serif;">Łuki</h1>
