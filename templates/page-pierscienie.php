...
?>
    <main>
        <div class="text-white place-center" style="background: url('<?= get_template_directory_uri() ?>/assets/img/pierscienie2.jpg') center / cover no-repeat;height: 600px;">
            <div>
                <h1 class="display-1 text-center mx-2" style="font-family: Poppins, sans-serif;">Pierścienie</h1>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="col col-lg-9">
                    ...
                    <p>Przewodnik po rodzajach i cechach kolczyków oraz efektach zaklęć.</p>
                    <?php
                        $args = array(
                            'post_type' => 'pierscien',
                            'posts_per_page' => 999,
