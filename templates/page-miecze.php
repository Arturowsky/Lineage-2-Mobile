...
?>
    <main>
        <div class="text-white place-center" style="background: url('<?= get_template_directory_uri() ?>/assets/img/i16174726409.jpg') center / cover no-repeat;height: 600px;">
            <div>
