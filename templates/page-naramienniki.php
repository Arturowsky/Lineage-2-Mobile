...
?>
    <main>
        <div class="text-white place-center" style="background: url('<?= get_template_directory_uri() ?>/assets/img/naramienniki.jpg') center / cover no-repeat;height: 600px;">
            <div>
                <h1 class="display-1 text-center mx-2" style="font-family: Poppins, sans-serif;">Naramienniki</h1>
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="col col-lg-9">
                    ...
                    <p>Przewodnik po typach i cechach naramienników</p>
                    <?php
                        $args = array(
                            'post_type' => 'naramiennik',
                            'posts_per_page' => 999,
                            'meta_key' => 'obrona',
                        ...
                        <div class="col text-center d-lg-flex d-xxl-flex justify-content-lg-center align-items-lg-center align-items-xxl-center col-lg-2">
                            <div class="d-inline-flex place-center">
                                <div class="place-center">
                                    <p class="m-0 p-0" style="font-size: 28px;"><?= get_field('obrona') ?></p>
                                    <p class="m-0 p-0 text-muted" style="font-size: 12px;">obrona</p>
                                </div>
                            </div>
                        </div>
                    </div>
